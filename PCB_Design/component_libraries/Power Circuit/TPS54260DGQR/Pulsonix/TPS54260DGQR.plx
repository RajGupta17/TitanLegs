...
(library Library_1
	...
	(compDef "TPS54260DGQR" (originalName "TPS54260DGQR") (compHeader (numPins 11) (numParts 1) (refDesPrefix IC)
		...
		(compPin "9" (pinName "GND_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/TPS54260")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS54260DGQR.stp")
